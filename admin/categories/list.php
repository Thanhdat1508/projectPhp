        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><img src="<?php echo $path_upload . $img_cate ?>" alt="ảnh lỗi" width="100px" height="100px" style="object-fit:contain;"></td>
                        ...
                        <td><a style="" href="index.php?act=categories&deletecategory&id_cate=<?php echo $id_cate ?>"> <input type="button" class="btn btn-warning" value="Xóa"></a></td>
                    </tr>
            <?php
                }
            }
