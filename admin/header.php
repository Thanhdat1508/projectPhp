...
<head>
  ...
  <!-- Favicons -->
  <link href="../public/admin/assets/js/img/favicon.png" rel="icon">
  <link href="../public/admin/assert/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <link href="../public/admin/assets/css/admin.css" rel="stylesheet" type="text/css">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="?act=categories&addcategory">
              <i class="bi bi-circle"></i><span>Thêm danh mục</span>
            </a>
          </li>
          <li>
            <a href="?act=categories&listcategory">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="?act=product&addproduct">
              <i class="bi bi-circle"></i><span>Thêm sản phẩm</span>
            </a>
          </li>
          <li>
            <a href="?act=product&listproduct">
              <i class="bi bi-circle"></i><span>Danh sách</span>
            </a>
          </li>
        </ul>
